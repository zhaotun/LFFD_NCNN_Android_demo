...
//init
LFFD::LFFD(const std::string& model_path, int scale_num )
{
	...
	if (num_output_scales == 5) {
		...
		bin_file_name = model_path+"/train_10_320_20L_5scales_v2_iter_1000000.bin";
...
void LFFD::SetNumThreads(int numThreads){
